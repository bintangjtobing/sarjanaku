                            ...
                            <div class="room">
                                ...
                                <div class="room-details">
                                    ...
                                    <div class="float-right">
                                        <a href="#" class="btn btn-colored">Book</a>
                                    </div>
                                </div>
                            </div>
                            <div class="room">
                    ...
                    <div class="col-lg-7">
                        ...
                        <div class="tabs p-r-20">
                            <ul class="nav nav-tabs nav-justified text-left" id="myTab">
                                <li class="nav-item"><a href="#day1" class="nav-link active" data-toggle="tab"
                                        aria-selected="true"><strong>Day 01</strong> <br>17.10.2015</a></li>
                                <li class="nav-item"><a href="#day2" class="nav-link" data-toggle="tab"><strong>Day
                                            02</strong> <br>18.10.2015</a></li>
                                <li class="nav-item"><a href="#day3" class="nav-link" data-toggle="tab"><strong>Day
                                            03</strong> <br>19.10.2015</a></li>
                                <li class="nav-item"><a href="#day4" class="nav-link" data-toggle="tab"><strong>Day
